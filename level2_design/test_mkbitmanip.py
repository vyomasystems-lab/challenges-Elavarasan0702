...
def run_test(dut):
    ...
    for i in ins:
        ...
        mav_putvalue_src1 = 67
        mav_putvalue_src2 = 22
        mav_putvalue_src3 = 1678
        mav_putvalue_instr = int('0x'+i,16)
    ...
    # comparison
        ...
        assert dut_output == expected_mav_putvalue,"The error is occuring mav_putvalue_src1:{},mav_putvalue_src2:{},mav_putvalue_src3:{}, mav_putvalue_instr:{}".format(mav_putvalue_src1,mav_putvalue_src2,mav_putvalue_src3,i)

        if dut_output != expected_mav_putvalue:
            print("The error is occuring mav_putvalue_src1:{},mav_putvalue_src2:{},mav_putvalue_src3:{}, mav_putvalue_instr:{}".format(mav_putvalue_src1,mav_putvalue_src2,mav_putvalue_src3,i))
            
            print("dut_output:",dut_output)
            print("expected_mav_putvalue:",expected_mav_putvalue)